...
document.addEventListener('DOMContentLoaded', function () {
    var contactoItems = document.querySelectorAll('.contacto-item');

    contactoItems.forEach(function (item) {
        item.addEventListener('click', function () {
            var apodo = item.getAttribute('data-apodo');
            var nombre = item.getAttribute('data-nombre');
            var apellido = item.getAttribute('data-apellido');
            var telefono = item.getAttribute('data-telefono');

            document.getElementById('apodoContacto').innerText = apodo;
            document.getElementById('nombreContacto').innerText = nombre;
            document.getElementById('apellidoContacto').innerText = apellido;
            document.getElementById('telefonoContacto').innerText = telefono;

            document.querySelector('.contacto-info').style.display = 'block';
        });
    });
});
